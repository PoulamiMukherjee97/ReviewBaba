...
const Review = () => {
    ...
    const { id } = useParams(); 
    const cast = review?.actors?.split(',');
    useEffect(() =>{
    ...
    return <div className="mt-2 p-5 justify-content-center">
        <div className="row mx-0 bg-secondary p-3 border shadow-lg">
            <div className="col-12 col-md-4">
                <img src={review.image} onError={(e) => {
