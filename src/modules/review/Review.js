                        ...
                        <p>
                            ...
                            <div className="mt-3 row mx-0">
                                ...
                                <div className="col-md-9">
                                    ...
                                    <p className="px-2"><a target="_blank" href={review.imdbLink} className="text-light">Check Here</a></p>
                                </div>
                            </div>
                        </p>
                        <p>
                            ...
                            <div className="mt-3 row mx-0">
                                ...
                                <div className="col-md-9">
                                    ...
                                    <p className="px-2"><a target="_blank" href={review.rtLink} className="text-light">Check Here</a></p>
                                </div>
                            </div>
                        </p>
                    </div>
